...
class GUI:
    def __init__(self):
        ...
        if 'user_login_details.bak' not in os.listdir("user_login_dir"):
            ...
            self.login_shelf['default_image'] = 'default.jpg' #default image
        ...
        self.dp = Label(self.login, bg = "black", image = self.loading(self.img_f), width = 50, height = 35)
        ...
        #CONNECT BUTTON
        self.loadimage = ImageTk.PhotoImage(Image.open("login.png"))
        ...
        self.login.protocol("WM_DELETE_WINDOW", self.close_login)  #close login
        self.root.option_add("*tearOff", False)                    #Menu Option
        self.root.protocol("WM_DELETE_WINDOW", self.Close)         #Close root
    ...
    def preview(self, event):
        ...
        self.change_dp = Button(self.image_win, borderwidth = 0, text = "Change Profile Picture", padx = 2, pady = 2)
    ...
    def user_profile(self):
       ...
       #HEADING
        ...
        self.brand_logo= Image.open("icon.jpg")
    ...
    def chat_room(self,name,IP,PORT):
        ...
        self.canva.pack()
        self.welcome_img = ImageTk.PhotoImage(Image.open("icon.ico"))
        ...
        #SEND BUTTON
        self.img = ImageTk.PhotoImage(Image.open("send.jpg"))
